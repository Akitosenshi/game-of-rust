    ...
    pub fn step(&mut self) -> &Vec<Vec<bool>> {
        ...
        for row in 0usize..height {
            for col in 0usize..width {
                ...
                if self.field[prev_row][prev_col] {
                    count += 1
                };
                if self.field[prev_row][col] {
                    count += 1
                };
                if self.field[prev_row][next_col] {
                    count += 1
                };
                if self.field[row][prev_col] {
                    count += 1
                };
                if self.field[row][next_col] {
                    count += 1
                };
                if self.field[next_row][prev_col] {
                    count += 1
                };
                if self.field[next_row][col] {
                    count += 1
                };
                if self.field[next_row][next_col] {
                    count += 1
                };

                self.next[row][col] = if self.field[row][col] {
                    if count == 2 || count == 3 {
                        true
                    } else {
                        false
